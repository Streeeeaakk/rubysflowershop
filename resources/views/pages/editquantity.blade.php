...
<div class='loginpopup'>
    <div class='formPopup' id='editpopupForm'>
        <form class='formContainer' action='{{ route('edit_quantity')  }}' method='POST' enctype='multipart/form-data'>
                    @csrf  
                        <div class='form-item'>
                        <input type='number' hidden name='cart_ID' placeholder='Cart ID' id='cart_ID' value='{{ $prod_ID }}'>
                        </div>
                        <div class='form-item'>
